...
import { riwayatPembelian } from "../services/transaction.service.js";
...
export default function TransactionPage() {
  ...
  useEffect(() => {
    const fetchRiwayatPembelian = async () => {
      try {
        const pembelianRes = await riwayatPembelian(bulan, tahun);
      ...
      <div className="flex w-full h-182.5">
        ...
        <div className="w-4/5 h-auto bg-[#e6e6e6] text-[#313638]">
          <div className="bg-[#fefefe] px-6 py-3">
            {/* Header */}
            <div>
              <h3 className="text-2xl font-bold">Riwayat Transaksi Anda</h3>
              <p>Lihat riwayat transaksi anda di bulan ini</p>
            </div>

            <div className="mt-7 border-l-4 border-[#0E7085]">
              <h3 className="text-xl font-semibold pl-2">Laporan Transaksi</h3>
            </div>
